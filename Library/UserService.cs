...
namespace Library
{
    public class UserService
    {
        ...
        {
            // Перевірка, чи автор, видавець і жанр дійсно існують
        ...
        public void ReserveBookForCustomer(int bookId, string customerUsername)
        {
            ...
            if (book != null && user != null)
            {
                ...
                // Update the book's ReservedFor property
                book.ReservedFor = user.Id; // Set the reserved user ID
